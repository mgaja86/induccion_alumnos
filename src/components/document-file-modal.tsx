...
interface DocumentFileModalProps {
  isOpen: boolean;
  onClose: () => void;
}

export const DocumentFileModal = ({ isOpen, onClose }: DocumentFileModalProps) => {
  return (
      ...
      <DialogContent className="max-w-3xl bg-gradient-to-br from-isep-deep-purple to-isep-primary text-white border-0 shadow-2xl shadow-isep-primary/40">
        <DialogHeader className="text-center items-center">
          ...
          <p className="text-purple-200 text-lg max-w-md">
            Aprende a subir y gestionar tus documentos para completar tu expediente académico.
          </p>
        </DialogHeader>
        <div className="relative aspect-video rounded-lg overflow-hidden my-4 ring-2 ring-isep-accent/50">
          <iframe
            className="absolute top-0 left-0 w-full h-full"
            src="https://embed.app.guidde.com/playbooks/7gKDqEuLaVNWKzF3sCutEQ?mode=videoOnly"
            title="Subir Y Gestionar Documentos En Universidadisep"
            frameBorder="0"
