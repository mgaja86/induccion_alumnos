...
interface ContactActivitiesModalProps {
  isOpen: boolean;
  onClose: () => void;
}

export const ContactActivitiesModal = ({ isOpen, onClose }: ContactActivitiesModalProps) => {
  return (
      ...
      <DialogContent className="max-w-3xl bg-gradient-to-br from-isep-deep-purple to-isep-primary text-white border-0 shadow-2xl shadow-isep-primary/40">
        <DialogHeader className="text-center items-center">
          <DialogTitle className="text-3xl font-extrabold text-white mb-2">
            Contacto Docente y Actividades Evaluativas
          </DialogTitle>
          <p className="text-purple-200 text-lg max-w-md">
            Aprende cómo contactar a tus docentes y cómo funciona el sistema de evaluación de tus actividades.
          </p>
        </DialogHeader>
